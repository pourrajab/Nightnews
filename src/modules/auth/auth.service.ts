...
export class AuthService {
  ...
  // async loginWithPassword(passwordLoginDto: PasswordLoginDto, res: Response) {
  ...
  //   res.cookie(CookieKeys.AccessToken, accessToken, CookiesOptionsToken());
  //   res.json({ message: PublicMessage.LoggedIn, accessToken, user });
  //   return;
  // }
